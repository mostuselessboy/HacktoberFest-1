...
class player(pygame.sprite.Sprite):
    def __init__(self, imgfile, radius, mass=1.0, gravity=9.8, friction_magnitude=1):
        ...
        self.friction = -0.00001*friction_magnitude
        self.g = gravity
    ...
    def draw(self, surface):
        ...
        rect.center = (self.state[0], 640 - self.state[1]) 
